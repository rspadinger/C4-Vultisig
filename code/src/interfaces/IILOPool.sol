...
/// and authorized.
interface IILOPool is IILOVest, IILOSale, IILOPoolImmutableState, IERC721Metadata, IERC721Enumerable {
    ...
    function positions(
        uint256 tokenId
    ) external view returns (uint128 liquidity, uint256 raiseAmount, uint256 feeGrowthInside0LastX128, uint256 feeGrowthInside1LastX128);
    ...
    function claimNew(uint256 tokenId) external payable returns (uint256 amount0, uint256 amount1);
